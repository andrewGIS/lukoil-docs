...
.. note:: Начиная с версии 0.18 результат выполнения запроса (графика), сохраняется во временной таблице **Последняя_выборка_графика**. Пример работы смотрите :ref:`здесь <working_with_selection>`
...
Данная команда позволяет быстро выбрать объекты по полю ID. 
    ...
    .. figure:: img/menuPanelCommand_2.png
        :align: center
        :alt: Расположение команды 
        :name: Расположение команды

        Расположение команды

При нажатии выводится простой диалог в котором можно ввести либо одно значение ID ``1499``, либо несколько значений в формате ``1499,1500``

    .. figure:: img/selection_by_id.png
        :align: center
        :alt: Пример диалога с введенным значением
        :name: Пример диалога с введенным значением

        Пример диалога с введенным значением


.. note:: Выбранные объекты сохранятся во временной таблице

Вывод по номеру договора
------------------------------------------------------------
...
При нажатии выводится простая. Для удобства она создана, с автодополнением, что позволяет не ошибаться при вводе. "Подсказки" выводятся из БД Земля. После выбора необходимого договора следует нажать **Выбрать договор**.

    .. figure:: img/selection_by_doc_name.png
        :align: center
        :alt: Пример диалога с введенным значением
        :name: Пример диалога с введенным значением 
